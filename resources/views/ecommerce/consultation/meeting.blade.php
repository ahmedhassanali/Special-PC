            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-12">
                        <img class="img-fluid" src="assets/img/video-call.png">
                    </div>
                    <div class="col-lg-6 col-12">
                        <h5 class="title-xs text-dark mb-3">الاقتراحات</h5>
                        <div class="row bg-light-gray">
                    
                            <div class="col-6 col-xs-12">
                                <div class="product-card">
                                    <button class="fav-circle text-gray" onclick="Favfunction(this)">
                                    ...
                                    <a href="product.html">
                                        <img loading="lazy" class="img-fluid" src="assets/img/P2PDWD0.jpg">
                                        <div class="details">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h6 class="title-xs text-default"> سماعات رأس</h6>
                                                <div class="price">
                                                    <del class="text-gray">
                                                        1000 ريال
                                                    </del>
                                            ...
                                            <p class="text-gray description">
                                                سماعة راس للالعاب من اولانرن سماعات ستيريو S5 PS4 Xbox One....
                                                سماعة راس للالعاب من اولانرن سماعات ستيريو S5 PS4 Xbox One...
                                            </p>
                                        </div>
                                    </a>
