...
<body>
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        <div class="form">
                            ...
                            <p class="text-default d-flex align-items-center">
                                قم بإدخال الايام و الاوقات المناسبة لك
                            </p>
                            <form class="row" id="booking-form">
                                <div id="calendar"></div>
                                <div id="day-info">
                                    <h6 id="selected-day" class="title-xs text-dark mb-2"></h6>
                                    <ul id="free-time-inputs">
                                        <li>
                                            <input type="time" class="free-time-input form-control">
                                        </li>
                                        <li>
                                            <input type="time" class="free-time-input form-control">
                                        </li>
                                        ...
                                        <button class="btn btn-white add-another-time">+</button>
                                    </ul>
                                </div>
                                <div class="col-12">
                                    <div class="pos-ab">
    ...
    <script>
        ...
        $('.add-another-time').on('click', function () {
            $('.free-time-inputs').innerHTML += `<li><input type="time" class="free-time-input form-control"></li>`;
        });
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function (info) {
                    ...
                    selectedDay.innerText = `التاريخ: ${info.start.toLocaleDateString()}`;
                    var freeTimeInputs = document.getElementById('free-time-inputs');
                    freeTimeInputs.style.display = 'flex';
                }
            });
            calendar.render();
        });
