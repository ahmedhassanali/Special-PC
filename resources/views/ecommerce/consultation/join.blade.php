...
<body>
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        <div class="form">
                            ...
                            <p class="text-default d-flex align-items-center">
                                قم بملىء طلب التقديم و سيتم الرد عليك في اقرب وقت
                            </p>
                            <form class="row">
                                <div class="col-lg-6 mb-2 justify-content-center align-items-center">
                                    <label class="text-default">
                                        الصورة
                                    </label>
                                    <div class="d-flex align-items-center">
                                        <label class="position-relative me-2" for="uploadfile-1"
                                            title="Replace this pic">
                                            <!-- Avatar place holder -->
                                            <span class="avatar avatar-xl">
                                                <img id="uploadfile-1-preview"
                                                    class="avatar-img rounded-circle border border-white border-3"
                                                    src="https://via.placeholder.com/150" alt="" width="100px"
                                                    height="100px">
                                            </span>
                                            <!-- Remove btn -->
                                        ...
                                        <!-- Upload button -->
                                        <label class="text-primary mb-0" for="uploadfile-1">تغيير</label>
                                        <input id="uploadfile-1" class="form-control d-none" name="photo" type="file">
                                    </div>
                                </div>

                                <div class="col-lg-6 mb-2 d-flex flex-column justify-content-center">
                                    <label class="text-default">
                                        الأسم
                                        <span class="text-red">*</span>
                                        <small class="text-gray">(يجب ان يكون الاسم مطابق في البنك)</small>
                                    </label>
                                    <input type="text" class="form-control" id="" placeholder="الأسم" required>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <input type="tel" class="form-control" id="" placeholder="0500000" required>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <label class="text-default">
                                        البريد الإلكتروني
                                    ...
                                    <input type="email" class="form-control" id="" placeholder="البريد" required>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <label class="text-default">
                                        الجنس
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <select class="form-select">
                                        <option selected>قم باختيار المدينة</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="pos-ab">
                                        <button type="submit" class="w-50 btn btn-primary">التالي</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script src="https://special-pc.com/assets/js/main.js"></script>
</body>
