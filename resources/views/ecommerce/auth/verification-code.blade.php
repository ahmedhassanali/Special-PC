            ...
            <div class="col-lg-6 col-md-7 col-12">
                <div class="form" >
                    <h4 class="text-dark mb-3 text-center">
                        {{ __('ecommerce.verify_email') }}
                    </h4>
                    <p class="text-default text-center">
                        {{ __('ecommerce.enter_code') }}
                    </p>
                    <form class="row" action="{{ route('ecommerce.checkVerificationCode') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-6 mb-2">
                            ...
                            <div class="col-lg-12 mb-2">
                                ...
                                <input type="email" class="form-control" name="email" id="" placeholder="{{ __('ecommerce.email') }}" required>
                            </div>
                            @else
                                <input type="email" class="form-control" hidden name="email" value="{{ $email }}" placeholder="{{ __('ecommerce.email') }}" required>
                            @endif
                            <label class="text-default">
                                {{ __('ecommerce.code') }}
                            </label>
                        ...
                        <div class="col-12">
                            <div class="pos-ab">
                                ...
                                <a class="link" id="resend" href="{{ route('ecommerce.verificationCode.email.Form') }}">
