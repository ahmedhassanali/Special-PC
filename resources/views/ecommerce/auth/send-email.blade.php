                ...
                <div class="col-lg-6 col-md-7 col-12">
                    <div class="form">
                        <h4 class="text-dark mb-3 text-center">
                            {{ __('ecommerce.resend_verification_code') }}
                        </h4>
                        <p class="text-default text-center">
                            {{ __('ecommerce.enter_registered_email') }}
                            {{ __('ecommerce.will_send_code') }}
                        </p>
                        <form class="row" action="{{ route('ecommerce.sendVerificationEmail') }}" method="POST"
