        ...
        <div class="row mb-3">
            <div class="col-12 my-2 d-flex justify-content-between">
                <h4 class="h4 mt-3 mx-3 mb-sm-0">
                    {{ __('dashboard.add_new_subcategory') }} ({{ $category->title }})
                </h4>
            </div>
        </div>
        <div class="card-body">
            <form class="row g-4"
                ...
                <div class="col-12">
                    ...
                    <div class="input-group">
                        <input required type="text" name="ar_title" class="form-control"  value="{{old('ar_title') }}">
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="input-group">
                        <input required type="text" name="en_title" class="form-control" value="{{old('en_title') }}" ">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        <input required type="text" name="ar_description" class="form-control" value="{{old('ar_description') }}">
                    </div>
                </div>
