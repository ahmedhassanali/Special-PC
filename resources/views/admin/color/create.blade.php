    ...
    <div class="page-content-wrapper m-3">
        ...
        <div class="row mb-3">
            <div class="col-12 d-flex justify-content-between">
                <h4 class="h4 mt-3 mx-3 mb-sm-0">{{ __('dashboard.add_new_color') }}</h4>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <form class="row g-4" action="{{ route('admin.color.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <input type="text" name="ar_short_name" class="form-control ar"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <input  type="text" name="en_short_name" class="form-control"
