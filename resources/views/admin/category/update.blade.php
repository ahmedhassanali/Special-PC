...
<div class="page-content-wrapper m-3">
    ...
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-between">
            <h4 class="h4 mt-3 mx-3 mb-sm-0">{{ __('dashboard.update_category') }}</h4>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <form class="needs-validation row g-4" novalidate="" enctype="multipart/form-data"  action="{{ route('admin.category.update',$category) }}" method="post" >
                    @csrf
                <!-- picture -->
                        ...
                        <label class="position-relative me-4" for="uploadfile-1" title="Replace this pic">
                            ...
                            <span class="">
                                <img style="width:150px; height:150px" id="uploadfile-1-preview"
                                    ...
                                    src="{{ isset($category) ? asset($category->image) : 'https://via.placeholder.com/150' }}"
                                    alt="" accept="image/*">
                            </span>
                            <!-- Remove btn -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input required type="text" name="ar_title" class="form-control ar"
                            value="{{ isset($category) ? $category->ar_title : old('ar_title') }}" placeholder="Arabic title">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input required type="text" name="en_title" class="form-control"
                            value="{{ isset($category) ? $category->en_title : old('en_title') }}" placeholder="English Title">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        <textarea name="ar_description" class="form-control ar" placeholder="Arabic Description">{{ isset($category) ? $category->ar_description : old('ar_description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        <textarea name="en_description" class="form-control" placeholder="English Description">{{ isset($category) ? $category->en_description : old('en_description') }}</textarea>
                    </div>
                </div>
